...
/*
    // Basic context API:----
        ...
        // Suppose we fetch an API.. then we can put data coming from API into global variable 'UserContext' uding 'setUsr' method. just like we did in login component.
*/    
    ...
    // Theme switcher :----
        ...
        //         //Define methods "darkTheme" and "lightTheme"
        //         const lightTheme=()=>{
        //             SetThemeMode("light");
        //         }
        //         const darkTheme=()=>{
    ...
    // Todo list :----
        ...
        //             const addTodo=(todo)=>{
        //                 //here 'todo' is a individual todo[todo message] that is coming from todos.
        ...
        //                     //[...prev,todo] --> we can't do this way, because each todo id a self object.
